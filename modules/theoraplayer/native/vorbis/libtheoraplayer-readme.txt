libvorbis's source code is here provided in minimalist distribution format
...
If you want to use libvorbis outside of libtheoraplayer, it is encouraged to use the
